...
- Kun CSV:ssä on kelvollinen Spotify track ID (`spotify_track_id`, `spotify_url` tai `spotify_uri`), biisi avautuu suoraan sivulla olevaan Spotify-soittimeen. Ennen avausta yritetään varmistaa, että upotus on toimiva (vähentää 404-tilanteita).
...
Sovellus yrittää ladata ensin `musiikkihitit_1930_2025_spotify.csv` tiedoston projektin juuresta, sitten varalla `musiikkihitit_1930_2025_yhdistetty.csv` tiedoston.
