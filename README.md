...
- satunnainen kappale,
- Spotify-avauslinkki (toimii myös jos upotus antaa 404),
- vuosiarvaus,
...
### Jos Spotify näyttää 404-virheen
Se on yleensä Spotify-upotuksen rajoitus, ei sinun virhe.

Tässä versiossa ratkaisu on:
1. Paina **Soita satunnainen biisi**
2. Klikkaa vihreää nappia **Avaa kappale Spotifyssa**
3. Kappale avautuu Spotifyyn uuteen välilehteen
...
- Spotify-soitin avataan nyt hakulinkillä kappaleen nimellä, joten listaa on helpompi kasvattaa.

## Top 20 kaikille vuosille 1930 alkaen
Tämä onnistuu, mutta tarvitsemme erillisen datalähteen (CSV/JSON), jossa jokaiselle vuodelle on kappalelista.
Nykyinen versio sisältää laajennetun harjoituskirjaston, ei vielä kaikkien vuosien virallista Top 20 -dataa.
