...
function toSpotifySearchEmbed(query) {
  return `https://open.spotify.com/embed/search/${encodeURIComponent(query)}`;
}
...
function drawSong() {
  ...
  spotifyEmbed.src = toSpotifySearchEmbed(currentSong.query);
  yearGuess.value = "";
